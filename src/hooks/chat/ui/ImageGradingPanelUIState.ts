import { DetailPanelUIState } from "./DetailPanelUIState";
import { ImagePanZoomUIState } from "./ImagePanZoomUIState";
import { StepSelectionUIState } from "./StepSelectionUIState";

export const ImageGradingPanelUIState = () => {
    const detailPanelState = DetailPanelUIState();
    const stepSelectionState = StepSelectionUIState();
    const imagePanZoomState = ImagePanZoomUIState();
