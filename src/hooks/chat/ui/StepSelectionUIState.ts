...
export const StepSelectionUIState = () => {
    ...
    const handleSelectStep = (stepIndex: number) => {
        ...
        const containerTop = stepListContainerElement.getBoundingClientRect().top;
        ...
        const targetTop =
            ...
            deltaTop -
            (stepListContainerElement.clientHeight - selectedStepElement.clientHeight) / 2;
