...
import { ChatSubmissionGuardUIState } from "./ChatSubmissionGuardUIState";
...
export const ChatMessagingUIState = ({
    currentSessionId,
    currentSessionIdRef,
    setCurrentSessionId,
    ...
    const handleSendMessage = async (
        ...
        const { activeId, isNewChat, chatTitle } = chatMessagingUseCases.prepareActiveSession({
            currentSessionId,
            setCurrentSessionId,
            setSessionTyping,
            newMessage,
        ...
        try {
            ...
            chatMessagingUseCases.upsertAssistantMessage(activeId, submitMessage.mode, aiResponse);
